...
type ClientInterface interface {
	...
	CancelDelivery(ctx context.Context, deliveryId string, cancelReq CancelRequestModel) error
	...
	CancelJob(ctx context.Context, jobId string, cancelReq CancelRequestModel) error
}
